                ...
                "setPage": function(page) {
                    ...
                    if (number < 0) {
                        ...
                        if (format.asterisk) {
                            ...
                            rStop = format.inactive
                                ? rStart + format.blockwide
                                : Math.min(rStart + format.blockwide, 1 + pages);
                        }
                    }
                    ...
                    while (++i < count) {
                        ...
                        case "block":
                            for (; rStart < rStop; ++rStart) {
                                ...
                                data["active"] =
                                    rStart <= pages || number < 0; // true if infinity series and rStart <= pages
                                data["first"] = 1 === rStart; // check if it is the first page
                                data["last"] =
                                    rStart === pages && 0 < number; // false if infinity series or rStart != pages
                    ...
                    if (self.length) {
                        ...
                        $("a", self["html"](buffer)).click(opts["onClick"] ||
                            function(ev) {
                                ev["preventDefault"]();
