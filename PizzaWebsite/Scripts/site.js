    ...
    createPaginationCustomized: (paginationSelector, currentPage, rowsPerPage, totalPages, totalNumberOfItems, pageUrlParameter) => {
        ...
        $(paginationSelector).paging(totalNumberOfItems,
            { // Total number of items (elements)
                ...
                format:
                    finalFormat, // define how the navigation should look like and in which order onFormat() get's called
                ...
                onFormat:
                    function(type) { // Gets called for each character of "format" and returns a HTML representation
                        ...
                        {
                            if (page === currentPage) {
                                return `<li class="page-item active" aria-current="page"><a class="page-link" href="#">${
                                    page}</a></li>`;
                            } else {
                                return `<li class="page-item"><a class="page-link" href="${hrefValue}">${page
                                    }</a></li>`;
                            }
                        }
                        case "next": // >
